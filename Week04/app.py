...
app.secret_key=os.urandom(12).hex() # 設定 Session 的密鑰，才能開始使用!!
...
def square():
    ...
    # result=request.form["calculate"]
    # return render_template("status.html", header="正整數平方計算結果", login_infor=number)
    # return "123"

@app.route("/square/<targetNum>")
